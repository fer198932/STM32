...
void controlFunc(void)
{
	...
	switch(commandKey)
	{
		...
		case 0x0400:
			...
			cleanTools();
			break;
		// ¸´Î»»Ø»úÐµÁãµã£¬²¢¼ÇÂ¼ÏÂ»ØÁãµã×ß¹ýµÄ¾àÀë
		case 0x000F:			
			#ifdef RESET_DEBUG
			while(1)
			{
				...
				// yÖáÔË¶¯100mm-ÎÞ¼Ó¼õËÙ
				yAxisUpNStep(100 * 400);			// 8Ï¸·Ö					
				
				// yÖáÔË¶¯100mm-ÓÐ¼Ó¼õËÙ
//				yAxisStepFlag = 0;
//				yAxisPlusNum = 1;						// ²»ÄÜÎª0
//				rs232DataProcStep3();		
...
#ifndef IF_ADDSUB_WORK_COMDATAPROC				
				// ²»¼Ó¼õËÙ
				noAddSubSpeed();
#else				
				//*************Elsie***********
